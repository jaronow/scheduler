    ...
    <b-navbar toggleable="lg" type="dark" variant="info">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          ...
          <b-nav-item to="employees">People</b-nav-item>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-dropdown ref="user_dropdown" text="User" class="m-2" right no-caret variant="info" v-if="$store.state.isLoggedIn">
            <b-dropdown-item class="user-profile" to="profile">Profile</b-dropdown-item>
            <b-dropdown-item class="user-calendar" to="calendar">Calendar</b-dropdown-item>
